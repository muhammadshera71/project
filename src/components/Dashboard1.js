    ...
    <div class="flex flex-col relative ">
        <div id="menu" class="bg-gray-900 min-h-screen z-10 text-slate-300 w-64 fixed left-0 h-screen overflow-y-scroll">
           <div id="logo" class="my-4 px-6">
            <h1 class="text-lg md:text-2xl font-bold text-white">Amazon<span class="text-blue-500">8</span>.</h1>
           ...
           <div id="profile" class="px-6 py-10">
            ...
            <a href="#" class="inline-flex space-x-2 items-center">
                <span>
                    <img class="rounded-full w-8 h-8" src="/assets/userlogo.png" alt=""/>
                </span>
           ...
           <div id="nav" class="w-full px-6">
            <a href='dashboard' class="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 bg-blue-800 hover:bg-white/5 transition ease-linear duration-150">
                <div>
